...
public abstract class ScreenImp implements Screen{
	...
	private void gameLoop() {
		...
		while(running)
		{
			...
			g.drawString(""+ ((timePassed == 0 ? "Too Fast" : 1000000000/timePassed)) +" FPS : Time Passed Per Frame: "+timePassed/1000000, Application.getGame().getScreenWidth()/2, 50);
			g.dispose();
	...
	{
		g.setColor(0, 0, 0);
		g.fillRect(0, 0, Application.getGame().getScreenWidth(), Application.getGame().getScreenHeight());
	}
